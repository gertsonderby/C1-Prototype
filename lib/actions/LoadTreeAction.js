            ...
            let treeItemData = elements.map((element) => {
                ...
                if (actions) {
                    ...
                    actions.forEach((actionData) => {
                        ...
                        if (actionData.ActionGroup) {
                            let key = actionData.ActionGroup.GroupId;
                            if (!actionGroups[key]) {
                                actionGroups[key] = new ActionGroup(actionData.ActionGroup);
                            }
                            actionGroups[key].actions.push(action);
                            action.group(actionGroups[key]);
                        }
                ...
                if (actionKeys) {
                    ...
                    actionKeys.forEach((key) => {
                        ...
                        if (group) element.actionGroups.push(group);
                    });
